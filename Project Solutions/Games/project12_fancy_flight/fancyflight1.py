...
while running:
    ...
    if(game.curscreen=="game"):
        ...
        start_text_surface = my_font.render('Fancy Flight', False, (0,0,0))
        press_text_surface= my_font.render('Press Space to Start',False,(0,0,0))
        screen.blit(start_text_surface, (100,100))

        screen.blit(press_text_surface, (100,300))
    elif(game.curscreen=="gameover"):
        game_over_surface = my_font.render('Game Over', False, (0,0,0))
        score_surface=my_font.render("Score: "+str(game.score), False, (0,0,0))
        play_again_surface= my_font.render('Press Space to Play Again',False,(0,0,0))

        screen.blit(game_over_surface, (100,100))
        screen.blit(score_surface, (100,300))
        screen.blit(play_again_surface, (100,500))
